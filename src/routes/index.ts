...
router.post('/menu/items', authenticate, authorize('administrator', 'manager', 'cashier', 'head_chef'), createMenuItem);
router.post('/menu/upload', authenticate, authorize('administrator', 'manager', 'cashier', 'head_chef'), uploadMenuImage);
router.put('/menu/items/:id', authenticate, authorize('administrator', 'manager', 'cashier', 'head_chef'), updateMenuItem);
router.put('/menu/items/:id/stock', authenticate, authorize('administrator', 'manager', 'cashier', 'head_chef'), adjustMenuItemStock);
router.delete('/menu/items/:id', authenticate, authorize('administrator', 'manager', 'cashier', 'head_chef'), deleteMenuItem);
...
// flipping a status flag, same trust level as deleting a custom role.
router.delete('/staff/:id', authenticate, authorize('administrator'), deleteStaff);
